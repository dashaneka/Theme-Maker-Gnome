...
def generate_index_theme(name: str, p: dict) -> str:
    mode = p.get("mode", "dark")
    slug = name.lower().replace(" ", "-")
    return f"""[Desktop Entry]
Type=X-GNOME-Metatheme
Name={name}
Comment={mode.title()} theme auto-generated by Theme Maker
Encoding=UTF-8
...
def write_gtk_files(output_dir: Path, p: dict, name: str):
    ...
    (gtk_theme_dir / "index.theme").write_text(generate_index_theme(name, p))
