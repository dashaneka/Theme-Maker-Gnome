...
:root {{
  ...
  --lwt-toolbar-field-highlight-text: {p["accent_fg"]} !important;
...
@-moz-document url-prefix("about:") {{
  :root {{
    ...
    --in-content-primary-button-text-color: {p["accent_fg"]} !important;
...
def generate_chrome_manifest(p: dict, name: str) -> str:
    ...
    data = {
        ...
        "name": name,
        "description": (
            f"{p.get('mode', 'dark').title()} theme with accent colors - "
            "auto-generated by Theme Maker"
        ),
        "theme": {
            "colors": {
